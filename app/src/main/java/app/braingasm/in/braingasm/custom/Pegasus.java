...
public class Pegasus {
    private static Pegasus mInstance;
    private RequestQueue mRequestQueue;
    private ImageLoader mImageLoader;
    private static Context mCtx;

    private Pegasus(Context context) {
        mCtx = context;
    ...
    public static synchronized Pegasus getInstance(Context context) {
        if (mInstance == null) mInstance = new Pegasus(context);
        return mInstance;
    }
